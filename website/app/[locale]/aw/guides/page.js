...
export default function GuidesPage() {
  ...
  const allGuides = useMemo(() => [
    ...
    },
    {
      ...
      category: locale === 'nl' ? 'Hypotheken' : 'Mortgages',
      link: locale === 'nl' ? '/aw/guides/kunnen-buitenlanders-een-huis-kopen-op-aruba-gids-2025' : '/aw/guides/can-foreigners-buy-property-in-aruba-2025-guide',
    ...
    },
    {
      ...
      category: locale === 'nl' ? 'Hypotheken' : 'Mortgages',
      link: locale === 'nl' ? '/aw/guides/hypotheek-vereisten-in-aruba-2025-gids' : '/aw/guides/mortgage-requirements-in-aruba-2025-guide',
    ...
    },
    {
      ...
      category: locale === 'nl' ? 'Hypotheken' : 'Mortgages',
      link: locale === 'nl' ? '/aw/guides/wat-is-een-annuiteitenhypotheek-in-aruba-2025-gids' : '/aw/guides/what-is-an-annuity-mortgage-in-aruba',
    ...
    },
    {
      ...
      category: locale === 'nl' ? 'Hypotheken' : 'Mortgages',
      link: locale === 'nl' ? '/aw/guides/hoeveel-kun-je-lenen-in-aruba-2025-gids' : '/aw/guides/how-much-can-you-borrow-in-aruba',
    ...
    },
    {
      ...
      category: locale === 'nl' ? 'Hypotheken' : 'Mortgages',
      link: locale === 'nl' ? '/aw/guides/eigendom-vs-erfpacht-in-aruba-2025-gids' : '/aw/guides/freehold-vs-lease-land-in-aruba',
