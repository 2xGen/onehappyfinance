...
export const metadata = {
  title: 'Freehold vs. Lease Land in Aruba (Eigendom vs Erfpacht)',
  description: 'Eigendom (freehold) means full ownership; Erfpacht (lease land) is a 60-year renewable lease with annual fees. Control, costs, financing, and resale differ. Here\'s what to verify.',
  keywords: [
  ...
  openGraph: {
    title: 'Freehold vs. Lease Land in Aruba (Eigendom vs Erfpacht)',
    description: 'Eigendom (freehold) means full ownership; Erfpacht (lease land) is a 60-year renewable lease with annual fees. Control, costs, financing, and resale differ.',
    type: 'article',
    images: [
...
function ArticleSchema() {
  const jsonLd = {
    '@context': 'https://schema.org',
    '@type': 'Article',
    headline: 'Freehold vs. Lease Land in Aruba (Eigendom vs Erfpacht)',
        ...
        <div className="lg:col-span-8 space-y-10">
          ...
          <section id="lease-land" className="rounded-3xl border bg-white/80 backdrop-blur p-6 md:p-8 shadow-sm">
            ...
            <div className="mt-6 space-y-4">
              <div>
                <h3 className="font-semibold text-foreground">Annual lease fee (canon)</h3>
                <p className="mt-1 text-foreground/80 leading-7">Paid to the government; amount depends on location, land value, and contract terms. May be fixed, indexed, or periodically renegotiated.</p>
              </div>
              <div>
                <h3 className="font-semibold text-foreground">Sale/transfer restrictions</h3>
                <p className="mt-1 text-foreground/80 leading-7">Is the lease assignable? What approvals are needed on transfer? Government or lessor approval is often required.</p>
              </div>
              <div>
                <h3 className="font-semibold text-foreground">Ownership of buildings</h3>
                <p className="mt-1 text-foreground/80 leading-7">You own the structures on the land; the land remains government property. At end of lease, what happens to improvements depends on the contract.</p>
              </div>
              <div>
                <h3 className="font-semibold text-foreground">Mortgage options</h3>
                <p className="mt-1 text-foreground/80 leading-7">Lenders often require a minimum remaining lease term that comfortably exceeds the mortgage term. Some leases need lessor consent to grant a mortgage.</p>
              </div>
            </div>
          </section>

          <section id="verify-lease" className="rounded-3xl border bg-white/80 backdrop-blur p-6 md:p-8 shadow-sm">
          ...
          <section id="pros-cons" className="rounded-3xl border bg-white/80 backdrop-blur p-6 md:p-8 shadow-sm">
            ...
            <div className="mt-4 overflow-x-auto rounded-2xl border bg-white shadow-sm">
              <table className="min-w-full text-sm">
                ...
                <tbody className="divide-y">
                  <tr><td className="p-3">Freehold</td><td className="p-3">Full ownership, easier resale, often better financing</td><td className="p-3">Higher purchase price</td></tr>
                  <tr><td className="p-3">Lease Land</td><td className="p-3">Lower initial cost, available in prime locations</td><td className="p-3">Annual fees, restrictions, stricter bank requirements</td></tr>
                </tbody>
              </table>
            </div>
          </section>

          <section id="due-diligence" className="rounded-3xl border bg-white/80 backdrop-blur p-6 md:p-8 shadow-sm">
          ...
          <section id="red-flags" className="rounded-3xl border bg-white/80 backdrop-blur p-6 md:p-8 shadow-sm">
          ...
          <section id="which-choose" className="rounded-3xl border bg-white/80 backdrop-blur p-6 md:p-8 shadow-sm">
          ...
          <RelatedGuides locale={params?.locale || 'en'} keys={RELATED_KEYS.freeholdVsLease} />
        </div>
        ...
        <aside className="lg:col-span-4">
          <div className="lg:sticky lg:top-24 rounded-3xl border bg-white/70 backdrop-blur p-6 shadow-sm">
            ...
            <nav className="mt-4 grid gap-2">
              {[
                { id: 'freehold', label: 'Freehold Property (Eigendom)' },
                { id: 'lease-land', label: 'Lease Land (Erfpacht)' },
                { id: 'verify-lease', label: 'What to Verify in a Lease' },
                { id: 'financing', label: 'Financing in Aruba' },
                { id: 'pros-cons', label: 'Pros and Cons' },
                { id: 'due-diligence', label: 'Due Diligence Checklist' },
