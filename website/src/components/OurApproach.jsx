...
const OurApproach = () => {
  ...
  return (
    <section ref={ref} className="py-16 md:py-28 bg-gradient-to-b from-background via-gray-50/50 to-background relative">
        ...
        <div className="grid md:grid-cols-2 gap-6 md:gap-16 items-center">
          ...
          >
            ...
            <div className="space-y-4 text-lg text-foreground/80 text-center md:text-left">
              <p>
                {t('ourApproach.paragraph1')}
              </p>
              <p>
                {t('ourApproach.paragraph2')}
              </p>
            </div>
            <motion.div
              initial="hidden"
          ...
          <motion.div
            className="relative order-2 mt-6 md:mt-0"
            initial="hidden"
            animate={inView ? "visible" : "hidden"}
            variants={{
